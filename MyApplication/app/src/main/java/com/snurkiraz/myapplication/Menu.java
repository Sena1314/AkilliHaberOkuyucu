...
public class Menu extends AppCompatActivity {
    ...
    private static final String URL = "http://akillihaberokuyucu.somee.com/Ak%C4%B1ll%C4%B1Haber.asmx";
    ...
    private static final String URL1 = "http://akillihaberokuyucu.somee.com/Ak%C4%B1ll%C4%B1Haber.asmx";
...
if(soapEmployee.hasProperty("Table")) {
    ...
    for (int i = 0; i < employeeCount; i++) {
        ...
        yazarAdi = soapEmployee1.getProperty(0).toString();
        list.add(yazarAdi);
    }
...
if (soapEmployee1.hasProperty("Table")) {
    ...
    for (int i = 0; i < employeeCount1; i++) {
        ...
        kategoriAdi = soapEmployee2.getProperty(0).toString();
